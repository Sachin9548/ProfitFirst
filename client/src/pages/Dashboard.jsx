...
const Dashboard = () => {
  ...
  const shippingData = [
    ["Total Shipments", "2.2K"],
    ["Pickup Pending", "71"],
    ["In-Transit", "315"],
    ["Delivered", "1.1K"],
    ["NDR Pending", "182"],
    ["RTO", "594"],
    ["Total COD (Last 30 Days)", "₹14.3L"],
    ["COD Available", "₹0"],
    ["COD Pending", "₹0"],
    ["Last COD Remitted", "₹37.7K"],
  ];

  const websiteChart = [
    { name: "Jan 2025", newCustomers: 800, returningCustomer: 150 },
